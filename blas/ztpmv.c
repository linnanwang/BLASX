                 ...
                 const int N, const void *Ap, void *X, const int incX)
{
    ...
    if (cblas_ztpmv_p == NULL) blasx_init_cblas_func(&cblas_ztpmv_p, "cblas_ztpmv");
    Blasx_Debug_Output("Calling cblas_ztpmv\n ");
    (*cblas_ztpmv_p)(Order,Uplo,TransA,Diag,N,Ap,X,incX);
}

/* f77 interface */
void ztpmv_(char *uplo, char *transa, char *diag, int *n, double *Ap, double *X, int *incx)
{
    ...
    cblas_ztpmv(CblasColMajor, Uplo,
                TransA, Diag,
                *n, Ap, X, *incx);
}
