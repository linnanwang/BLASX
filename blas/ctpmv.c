                 ...
                 const int N, const void *Ap, void *X, const int incX)
{
    ...
    if (cblas_ctpmv_p == NULL) blasx_init_cblas_func(&cblas_ctpmv_p, "cblas_ctpmv");
    Blasx_Debug_Output("Calling cblas_ctpmv\n ");
    (*cblas_ctpmv_p)(Order,Uplo,TransA,Diag,N,Ap,X,incX);
}

/* f77 interface */
void ctpmv_(char *uplo, char *transa, char *diag, int *n, float *Ap, float *X, int *incx)
{
    Blasx_Debug_Output("Calling ctpmv_ interface\n");
    ...
    cblas_ctpmv(CblasColMajor, Uplo,
                TransA, Diag,
                *n, Ap, X, *incx);
}
