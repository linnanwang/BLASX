                 ...
                 const int N, const void *Ap, void *X, const int incX)
{
    ...
    if (cblas_ctpsv_p == NULL) blasx_init_cblas_func(&cblas_ctpsv_p, "cblas_ctpsv");
    Blasx_Debug_Output("Calling cblas_ctpsv\n ");
    (*cblas_ctpsv_p)(Order,Uplo,TransA,Diag,N,Ap,X,incX);
}

/* f77 interface */
void ctpsv_(char *uplo, char *transa, char *diag, int *n, float *Ap, float *X, int *incx)
{
    Blasx_Debug_Output("Calling ctpsv_ interface\n");
    ...
    cblas_ctpsv(CblasColMajor, Uplo,
                TransA, Diag,
                *n, Ap, X, *incx);
}
