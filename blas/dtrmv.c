/*
 * -- BLASX (version 1.0.0) --
 * @generated d Tue Apr  8 15:40:27 2014
 */
                 ...
                 double *X, const int incX)
{
    ...
    if (cblas_dtrmv_p == NULL) blasx_init_cblas_func(&cblas_dtrmv_p, "cblas_dtrmv");
    Blasx_Debug_Output("Calling cblas_dtpmv\n ");
    (*cblas_dtrmv_p)(Order,Uplo,TransA,Diag,N,A,lda,X,incX);
}

/* f77 interface */
void dtrmv_(char *uplo, char *transa, char *diag, int *n, double *A, int *lda,
                      double *X, int *incx)
{
    ...
    cblas_dtrmv(CblasColMajor, Uplo,
                TransA, Diag,
                *n, A, *lda,
                X, *incx);
}
